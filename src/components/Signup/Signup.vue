        ...
        <div class="contentContainer">
            ...
            <form enctype="multipart/form-data" class="signupForm" @submit.prevent="handleSignup">
                <input class="loginFormField" type="text" placeholder="Email" required
                    autocomplete="mike.82pronka.27a@gmail.com" />
                <input class="loginFormField" type="text" placeholder="Username" required autocomplete="versevent" />
                <input v-model="userPassword" class="loginFormField" type="password" placeholder="Password" required
                    autocomplete="12345678aA" />
                <input v-model="confirmUserPassword" class="loginFormField" type="password" placeholder="Confirm password"
                    required autocomplete="12345678aA" />
    ...
    methods: {
        async handleSignup(e) {
            ...
            if (this.userPassword !== this.confirmUserPassword) {
                return Notiflix.Notify.failure('Incorrect password');
            }
